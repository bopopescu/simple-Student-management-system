...
urlpatterns = [
    ...
    # #add fee
    url(r'^fee/(?P<pk>[0-9]+)/$',views.FeeList.as_view(),name='fee_list'),
    #fee list
    url(r'^add/fee/$',views.AddFee.as_view(),name='add_fee'),
    #pay fee
    url(r'^pay/fee/(?P<pk>[0-9]+)/$',views.PayFees.as_view(),name='pay_fees'),
    #display fee
    url(r'^fee/display/(?P<pk>[0-9]+)/$',views.FeeDisplay.as_view(),name='fee_display'),
